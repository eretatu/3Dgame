...
namespace ArborEditor
{
	...
	internal sealed class ParameterConditionListEditor : PropertyEditor
	{
		...
		private void OnRemove(ReorderableList list)
		{
			...
			ParameterCondition condition = EditorGUITools.GetPropertyObject<ParameterCondition>(elementProperty);
			if (condition != null)
			{
				condition.Destroy();
			}
		...
		private void ConditionGUI(ParameterConditionProperty conditionProperty)
		{
			...
			switch (parameterType)
			{
				...
				case Parameter.Type.AssetObject:
					{
						_LayoutArea.PropertyField(valueProperty, EditorGUITools.GetTextContent("AssetObject Value"));
					}
					break;
