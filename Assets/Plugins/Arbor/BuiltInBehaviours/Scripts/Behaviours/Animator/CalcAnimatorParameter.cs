		...
		void DoCalc(ExecuteMethodFlags executeMethodFlags)
		{
			...
			switch (_Reference.type)
			{
				case AnimatorControllerParameterType.Float:
					{
						float value = animator.GetFloat(_ParameterID);
						switch (function)
						{
				...
				case AnimatorControllerParameterType.Int:
					{
						int value = animator.GetInteger(_ParameterID);
						switch (function)
						{
							case Function.Assign:
								value = intValue;
						...
						animator.SetInteger(_ParameterID, value);
					}
					break;
				case AnimatorControllerParameterType.Bool:
					{
						animator.SetBool(_ParameterID, boolValue);
					}
					break;
