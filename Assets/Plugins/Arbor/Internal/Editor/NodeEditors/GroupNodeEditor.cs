...
namespace ArborEditor
{
	...
	internal sealed class GroupNodeEditor : NodeEditor
	{
		...
		protected override void OnDrawMinimap(Rect nodeRect)
		{
			GroupNode groupNode = node as GroupNode;
			...
			Rect shadowRect = nodeRect;
			shadowRect.position += Vector2.one;
			Styles.whiteBorder.Draw(shadowRect, false, false, false, false);

			// frame
			GUI.backgroundColor = groupNode.color * Color.gray;
			Styles.whiteBorder.Draw(nodeRect, false, false, false, false);
