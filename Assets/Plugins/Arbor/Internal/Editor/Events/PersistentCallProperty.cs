...
namespace ArborEditor.Events
{
	...
	internal sealed class PersistentCallProperty
	{
		...
		IEnumerable<SerializedProperty> GetArgumentParameters()
		{
			...
			yield return parameterListProperty.vector4ParametersProperty;
			yield return parameterListProperty.vector2IntParametersProperty;
			yield return parameterListProperty.vector3IntParametersProperty;
			yield return parameterListProperty.rectIntParametersProperty;
			yield return parameterListProperty.boundsIntParametersProperty;
