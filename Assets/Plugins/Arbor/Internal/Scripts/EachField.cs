...
#endif
		public static List<T> Find(object obj, System.Type type)
		{
			s_FindList.list = new List<T>();
			s_FindList.Find(obj, type);
...
#endif
		public static void Find(object obj, System.Type type,List<T> list)
		{
...
#endif
		public static void Find(object obj, System.Type type, IFindReceiver receiver)
		{
			s_FindReceiver.receiver = receiver;
			s_FindReceiver.Find(obj, type);
		}
