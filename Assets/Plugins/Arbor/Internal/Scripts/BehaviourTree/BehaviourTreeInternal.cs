...
#pragma warning restore 1574
	...
	public abstract class BehaviourTreeInternal : NodeGraph
	{
		...
		private class NodeLinkSlotComparer : IComparer<NodeLinkSlot>
		{
			...
			public int Compare(NodeLinkSlot a, NodeLinkSlot b)
			{
		...
		internal void SortNodeLinkSlot(List<NodeLinkSlot> childrenLink)
		{
			...
			childrenLink.Sort(_NodeLinkSlotComparer);
		}
	}
}